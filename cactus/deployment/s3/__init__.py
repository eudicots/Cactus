...
class S3DeploymentEngine(object):
    ...
    def get_connection(self):
        ...
        return boto.connect_s3(aws_access_key.strip(), aws_secret_key.strip(),
                   host=self.site._s3_api_endpoint, is_secure=self.site._s3_is_secure, port=self.site._s3_port,
                   https_connection_factory=self.site._s3_https_connection_factory)
